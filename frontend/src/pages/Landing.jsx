    ...
    return (
        <div className="min-h-screen text-white relative">
            ...
            <div className="fixed inset-0 pointer-events-none -z-10">
                ...
                <div className="absolute top-1/2 -left-32 w-[500px] h-[500px] bg-indigo-600/12 rounded-full blur-3xl" />
                            ...
                            <div className="relative animate-float">
                                ...
                                <div className="relative bg-[#0D0A1E]/80 backdrop-blur-sm border border-violet-500/20 rounded-2xl p-5 shadow-2xl shadow-violet-900/30">
                                    ...
                                    <div className="space-y-3 text-sm">
                                        ...
                                        <div className="flex items-center gap-2 pt-2 mt-1 border-t border-emerald-500/20 bg-emerald-500/8 rounded-xl px-3 py-2.5">
