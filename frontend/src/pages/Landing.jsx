...
export default function Landing() {
    ...
    return (
        <div className="min-h-screen text-white relative overflow-x-hidden">
            ...
            {/* ── Fondo — absolute para que funcione en mobile ──────── */}
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute inset-0 bg-grid" />
                <div className="absolute -top-32 right-0 w-[700px] h-[700px] bg-violet-600/20 rounded-full blur-3xl" />
                <div className="absolute top-1/4 -left-32 w-[500px] h-[500px] bg-indigo-600/12 rounded-full blur-3xl" />
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-14">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                            {/* "Iniciar sesión" oculto en mobile para no romper el layout */}
                            <button
                                onClick={() => navigate('/login')}
                                className="hidden sm:block px-4 py-1.5 text-sm text-zinc-400 hover:text-white rounded-lg hover:bg-violet-500/8 transition-all"
                            >
                                Iniciar sesión
                            </button>
                            <button
                                onClick={() => navigate('/register')}
                                className="px-3 sm:px-4 py-1.5 bg-violet-600 hover:bg-violet-500 text-white text-sm font-medium rounded-lg transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-violet-600/25 whitespace-nowrap"
                            >
                                Crear cuenta
                            </button>
                        </div>
            ...
            {/* ── Todo el contenido en relative z-10 (sobre el fondo absolute) ── */}
            <div className="relative z-10">

                {/* ── Hero ──────────────────────────────────────────── */}
                <section className="pt-28 pb-20 px-4 sm:px-6 lg:px-8 relative">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-violet-600/15 rounded-full blur-3xl pointer-events-none" />
                    ...
                    <div className="max-w-6xl mx-auto relative">
                        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                            ...
                            <div className="text-center lg:text-left">
                                ...
                                <p className="text-base text-zinc-400 mb-8 leading-relaxed max-w-lg mx-auto lg:mx-0 animate-fade-in-up anim-d300">
                            ...
                            <div className="relative animate-slide-in-right anim-d300">
                                <div className="relative animate-float">
                                    <div className="absolute -inset-6 bg-violet-600/8 rounded-3xl blur-2xl" />
                                    <div className="relative bg-[#0D0A1E]/80 backdrop-blur-sm border border-violet-500/20 rounded-2xl p-5 shadow-2xl shadow-violet-900/30">
                                        ...
                                        <div className="space-y-3 text-sm">
                                            <div className="max-w-[85%] bg-white/[0.06] border border-white/[0.08] rounded-xl px-3.5 py-2.5">
                                                <p className="text-zinc-400 text-xs mb-1">Cliente · 10:23</p>
                                                <p className="text-zinc-100">Hola, busco depto 2 ambientes en Palermo, hasta USD 200k</p>
                                            </div>
                                            <div className="max-w-[85%] ml-auto bg-violet-500/15 border border-violet-500/25 rounded-xl px-3.5 py-2.5">
                                            ...
                                            <div className="max-w-[85%] bg-white/[0.06] border border-white/[0.08] rounded-xl px-3.5 py-2.5">
                                                <p className="text-zinc-400 text-xs mb-1">Cliente · 10:24</p>
                                                <p className="text-zinc-100">Para vivir, necesito para marzo que viene</p>
                                            </div>
                                            <div className="flex items-center gap-2 border-t border-emerald-500/20 bg-emerald-500/8 rounded-xl px-3 py-2.5 mt-1">
                                                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                                                <div>
                                                    <p className="text-xs text-emerald-300 font-semibold">Lead calificado</p>
                                                    <p className="text-xs text-zinc-400">Notificación enviada a tu equipo · 10:24</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                {/* ── Stats bar ─────────────────────────────────────── */}
                <section className="py-10 border-y border-violet-500/10 bg-violet-950/15">
                        ...
                        <div className="grid sm:grid-cols-3 gap-4">
                            {[
                                ...
                                <Reveal key={title} style={{ transitionDelay: `${i * 100}ms` }}>
                                    <div className="p-5 bg-red-500/[0.05] border border-red-500/[0.15] rounded-xl hover:-translate-y-0.5 transition-transform duration-200">
                            ...
                            {[
                                ...
                                <Reveal key={n} style={{ transitionDelay: `${i * 150}ms` }}>
                                    <div className="hover:-translate-y-0.5 transition-transform duration-200">
                                        <div className="text-5xl font-black text-violet-400/25 mb-4 leading-none tracking-tighter">{n}</div>
                            ...
                            {[
                                ...
                                <Reveal key={title} style={{ transitionDelay: `${i * 100}ms` }}>
                                    <div className={`group p-5 rounded-xl border transition-all duration-200 cursor-default hover:-translate-y-0.5 ${
                                        violet
                                            ? 'bg-violet-950/25 border-violet-500/15 hover:border-violet-500/30 hover:bg-violet-950/35'
                                            : 'bg-white/[0.03] border-white/[0.08] hover:border-violet-500/20 hover:bg-violet-950/15'
                                    }`}>
                                        <div className={`w-8 h-8 rounded-lg flex items-center justify-center mb-3 ${violet ? 'bg-violet-500/20' : 'bg-white/[0.06]'}`}>
                                            <Icon className={`w-4 h-4 ${violet ? 'text-violet-400' : 'text-zinc-300'}`} />
                                        </div>
                                        <h3 className="text-sm font-semibold text-white mb-1.5">{title}</h3>
                                        <p className="text-xs text-zinc-400 leading-relaxed">{desc}</p>
                                    </div>
                ...
                {/* ── CTA final ─────────────────────────────────────── */}
                <section className="py-24 px-4 sm:px-6 lg:px-8 border-t border-violet-500/10 relative">
                    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(124,58,237,0.10)_0%,transparent_70%)] pointer-events-none" />
