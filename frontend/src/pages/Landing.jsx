...
export default function Landing() {
    ...
    return (
        <div className="min-h-screen bg-[#060612] text-white relative overflow-x-hidden">
                    ...
                    <div className="flex justify-between items-center h-14">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className="px-4 py-1.5 bg-violet-600 hover:bg-violet-500 text-white text-sm font-medium rounded-lg transition-colors shadow-lg shadow-violet-600/25"
                            >
                                Crear cuenta
                            </button>
                        </div>
            ...
            <section className="pt-28 pb-20 px-4 sm:px-6 lg:px-8 relative">
                ...
                <div className="max-w-6xl mx-auto relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        {/* Left: texto */}
                        <div>
                            <div className="inline-flex items-center gap-2 bg-violet-500/10 border border-violet-500/20 text-violet-400 px-3 py-1.5 rounded-full text-xs font-medium mb-7">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                <button
                                    onClick={() => navigate('/register')}
                                    className="flex items-center justify-center gap-2 px-6 py-3 bg-violet-600 hover:bg-violet-500 text-white rounded-xl font-medium text-sm transition-colors shadow-lg shadow-violet-600/30"
                                >
                                    Crear cuenta gratis
                                ...
                                <a
                                    href="#como-funciona"
                                    className="flex items-center justify-center gap-2 px-6 py-3 border border-white/10 hover:border-violet-500/30 text-zinc-300 hover:text-white rounded-xl font-medium text-sm transition-all"
                                >
                                    Ver cómo funciona
                                </a>
                            </div>
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid sm:grid-cols-3 gap-4">
                        {[
                            ...
                            <div key={title} className="p-5 bg-red-500/[0.04] border border-red-500/[0.1] rounded-xl">
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 border-t border-violet-500/10 relative">
                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        ...
                        ].map(({ icon: Icon, title, desc, violet }) => (
                            <div key={title} className={`group p-5 rounded-xl border transition-all cursor-default ${
                                violet
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 border-t border-violet-500/10 relative">
                ...
                <div className="max-w-2xl mx-auto text-center relative z-10">
                    ...
                    <button
                        onClick={() => navigate('/register')}
                        className="inline-flex items-center gap-2.5 px-8 py-4 bg-violet-600 hover:bg-violet-500 text-white rounded-xl font-semibold text-sm transition-colors shadow-xl shadow-violet-600/30"
                    >
                        Crear cuenta gratis
                        <ArrowRight className="w-4 h-4" />
                    </button>
            ...
            <footer className="border-t border-violet-500/10 py-8 px-4 sm:px-6 lg:px-8">
                <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-sm font-semibold text-white">Ventra AI</span>
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <p className="text-xs text-zinc-700">© 2026 Ventra AI</p>
                    </div>
                </div>
            </footer>
        </div>
