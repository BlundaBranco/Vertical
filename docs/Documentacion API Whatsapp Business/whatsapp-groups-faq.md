...
> Source: https://developers.facebook.com/documentation/business-messaging/whatsapp/groups/faq
...
### How can I send my invite link to users?
  ...
  * A new utility template is available in the [Template Library⁠](https://business.facebook.com/wa/manage/template-library) to [send group invite links](/documentation/business-messaging/whatsapp/groups/reference#send-group-invite-link-template-message).
  * You may also create custom, free-form marketing templates.

### What countries is Groups available in?

  * Groups is available in [all countries Cloud API is available in](/documentation/business-messaging/whatsapp/support#country-restrictions).
