...
You can view, create, edit and delete QR codes and short links in the [WhatsApp Business Management API](/documentation/business-messaging/whatsapp/qr-codes) or in the [Business Manager UI⁠](https://www.facebook.com/business/help/890732351439459).
...
To create a QR code, send a POST request to the [WhatsApp Business Phone Number > Message Qrdls](/documentation/business-messaging/whatsapp/reference/whatsapp-business-phone-number/whatsapp-business-qr-code-management-api) endpoint.
...
To get a list of all QR codes on a business phone number, send a GET request to the [WhatsApp Business Phone Number > Message Qrdls](/documentation/business-messaging/whatsapp/reference/whatsapp-business-phone-number/whatsapp-business-qr-code-management-api) endpoint. To use the Business Manager to get a list of existing QR codes, see the [Help Center article⁠](https://www.facebook.com/business/help/890732351439459).
...
To get information about a specific QR code, send a GET request to the [WhatsApp Business Phone Number > Message Qrdls](/documentation/business-messaging/whatsapp/reference/whatsapp-business-phone-number/whatsapp-business-qr-code-management-api) endpoint and append the QR code ID as a path parameter.
...
To update a QR code, send a POST request to the [WhatsApp Business Phone Number > Message Qrdls](/documentation/business-messaging/whatsapp/reference/whatsapp-business-phone-number/whatsapp-business-qr-code-management-api) endpoint.
...
QR codes do not expire automatically. To delete a QR code, send a DELETE request to the [WhatsApp Business Phone Number > Message Qrdls](/documentation/business-messaging/whatsapp/reference/whatsapp-business-phone-number/whatsapp-business-qr-code-management-api) endpoint and append the ID of the QR code you wish to retire as a path parameter. To use the Business Manager to delete QR codes, see the [Help Center article⁠](https://www.facebook.com/business/help/890732351439459).
