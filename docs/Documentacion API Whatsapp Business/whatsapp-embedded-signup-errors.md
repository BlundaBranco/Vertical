...
This guide helps you get acquainted with the different errors that may arise as you during [Embedded Signup flow](/documentation/business-messaging/whatsapp/embedded-signup/implementation) in your website or client portal.

## Abandoned flow screens

If a business customer prematurely abandons the Embedded Signup flow, the system sends a [message event](/documentation/business-messaging/whatsapp/embedded-signup/implementation#session-logging-message-event-listener) to the browser that spawned the flow, that indicates which screen the customer was viewing when they abandoned the flow.
...
---|---  
``| [Business portfolio screen](/documentation/business-messaging/whatsapp/embedded-signup/default-flow#business-portfolio-screen)  
``| [WABA selection screen](/documentation/business-messaging/whatsapp/embedded-signup/default-flow#business-asset-selection-screen)  
``| [WABA creation screen](/documentation/business-messaging/whatsapp/embedded-signup/default-flow#business-asset-creation-screen)  
``| [Phone number addition screen](/documentation/business-messaging/whatsapp/embedded-signup/default-flow#phone-number-addition-screen)  
``| [Phone number verification screen](/documentation/business-messaging/whatsapp/embedded-signup/default-flow#phone-number-verification-screen)  
``| [Permissions review screen](/documentation/business-messaging/whatsapp/embedded-signup/default-flow#permissions-review-screen)  
...
1752004| One or more of the ad accounts in your business manager are currently in bad standing or in review. All of your accounts must be in good standing to create or add new ad accounts.|  1\. Go to [Business Support Home⁠](https://www.facebook.com/business-support-home).  
2\. Select your business.  
3\. Select your ad account to view any issues and available resolution options.   
1752140| You've reached your ad account maximum. You can increase your limit by making a payment on your business account. See your ad account limit in Business Manager (go to Business Settings, then Business Info).|  1\. Make a payment at [Billing⁠](https://www.facebook.com/ads/manager/account_settings/account_billing/) to increase your limit.  
2\. Check your current limit in your [settings⁠](https://business.facebook.com/settings) > Business Info.  
3\. Manage existing ad accounts at [Meta Business Suite⁠](https://business.facebook.com/) > Accounts > Ad Accounts.   
2455008| You've reached the maximum number of ad accounts allowed for a new business account. You'll be able to create more ad accounts after several weeks of following our policies or completing business verification.|  1\. Continue to follow Meta policies to increase your ad account limit.  
2\. Complete [business verification⁠](https://www.facebook.com/business/help/2058515294227817)  
...
Code| Description| Resolution  
---|---|---  
3441041| The phone number you have entered is not associated with the business you selected. To continue, you need to unlink this phone number from that business or enter a different number.|  1\. Enter a number associated with the business you selected.  
2\. Unlink the WhatsApp account associated with the entered number: Go to Meta Business Suite > Settings > Accounts > WhatsApp Accounts > Remove Account.  
3\. Unlink the phone number by deleting the number: Go to WhatsApp Manager > Phone Numbers tab.   
...
2\. Enter a different number already connected to WhatsApp Business to continue.   
...
2655093| The business is already sharing this WhatsApp Business Account with a partner. Switching partners is not supported in this flow. Disconnect the current partner in the WhatsApp Business App, then return here to connect a new partner.| 1\. Disconnect the current partner in the WhatsApp Business App   
2\. Connect a new partner.  
2655082| The phone number is already linked to a Facebook Page. To continue, you need to unlink your account or enter a different phone number to continue.|  To unlink a Facebook Page from a business portfolio:  
1\. Go to [Meta Business Suite⁠](https://business.facebook.com/).  
2\. Select your business.  
3\. Navigate to Settings > Accounts > Pages > Remove.   
...
Code| Description| Resolution  
---|---|---  
2655076| You are unable to create virtual numbers. Check account status in Business Support Home.|  Check account status in [Business Support⁠](https://www.facebook.com/business-support-home/) home.  
Select your business > WhatsApp Accounts > WhatsApp account to check if there are any restrictions on your account.   
...
1390008| We limit how often you can post, comment or do other things in a given amount of time in order to help protect the community from spam. You can try again later.| Try again later. [Learn more about feature limits.⁠](https://www.facebook.com/help/177066345680802)  
  
## Shared accounts

Code| Description| Resolution  
---|---|---  
2655049| This account is already shared with another partner, You can unshare this account with your partner, or create a new WhatsApp Business Account.| You can unshare this account with your partner, or create a new WhatsApp Business Account. [About shared accounts.⁠](https://www.facebook.com/business/help/524220081677109?id=2129163877102343A)  
...
1690061| Asset already belongs to this Business Manager.| Contact [Business Support⁠](https://www.facebook.com/business-support-home/).  
...
2655069| Error Accepting Marketing Messages Lite TOS. Please try again.| Contact [Business Support⁠](https://www.facebook.com/business-support-home/).  
...
2388001| Cannot create certificate.| See specific error in the message.  
