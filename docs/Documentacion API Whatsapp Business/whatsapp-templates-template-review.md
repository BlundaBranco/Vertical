...
Once you have created your template you can submit it for approval. It can take up to 24 hours for an approval decision to be made. Once a decision has been made, a notification will appear in your WhatsApp Manager and we will send an email to your Business Manager admins. In addition, we will send a [message_template_status_change](/documentation/business-messaging/whatsapp/webhooks/reference/message_template_status_update) webhook.
...
You can receive updates via the [message_template_status_update](/documentation/business-messaging/whatsapp/webhooks/reference/message_template_status_update) webhook, which notifies whether a template is approved, pending, or rejected.
