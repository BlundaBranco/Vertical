...
See [Template Pausing](/documentation/business-messaging/whatsapp/templates/template-pausing) to learn how to unpause a template that has been paused due to pacing.
