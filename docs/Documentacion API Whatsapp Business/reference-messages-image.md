...
## Triggers
  ...
  * A WhatsApp user forwards an [interactive reply button message to a business](/documentation/business-messaging/whatsapp/messages/interactive-reply-buttons-messages).
...
``_String_|  Media asset caption text.| `Taj Mahal`  
...
``_String_|  Media asset MIME type.| `image/jpeg`  
