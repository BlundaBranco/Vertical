...
The **history** webhook is used to synchronize the [WhatsApp Business app chat history](/documentation/business-messaging/whatsapp/embedded-signup/onboarding-business-app-users) of a business customer onboarded by a solution provider.
...
``_String_|  The WhatsApp user’s phone number.The `to` property is only included if the message object represents an [SMB message echo](/documentation/business-messaging/whatsapp/embedded-signup/onboarding-business-app-users#step-3--mirror-new-whatsapp-business-app-messages).| `16505551234`  
